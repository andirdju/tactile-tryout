 ...
 * Published location: http://tactilebeta.apps.netbiscuits.com/lib/tactile-framework-stub-beta-0.2.js
 * 
...
//added by andi
andi.custom = function() {
	this.deltaX = undefined;
	this.deltaY = undefined;
	this.slidedir = undefined;
	this.to = undefined;
	this.rowVal = undefined;
	this.colVal = undefined;
	this.typeVal = undefined;
	this.effect = undefined;
}
// end of added by andi
 ...
 * The behaviour of the hide effect can be configured with the config parameter. The type of the config object depends
